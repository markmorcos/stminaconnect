...
- **ADDED** Bundle id confirmation: `com.stminaconnect` (iOS) / `com.stminaconnect` (Android).
...
- **ADDED** Marketing URL (church website or simple landing page on `stminaconnect.com`) and support contact info.
